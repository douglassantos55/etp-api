...
func TestFinancingRepository(t *testing.T) {
	...
	if _, err := tx.Exec(`
        ...
        (1, 100000, 6, 1, '2023-11-15 15:53:05'),
        (2, 100000, 6, 1, '2023-12-01 02:55:03'),
        (3, 120000, 6, 1, '2023-12-20 11:34:52'),
        (4, 30000, 6, 1, '2023-12-21 13:34:52'),
        (5, 355000, 6, 1, '2023-12-25 13:34:52')
    `); err != nil {
		t.Fatalf("could not seed database: %s", err)
	}
